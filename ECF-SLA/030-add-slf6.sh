...
hammer repository create --gpg-key="Scientific Linux" --name='SLF 6x - x86_64' --organization=${MY_ORG} --product='Scientific Linux Fermi 6' --content-type='yum' --publish-via-http=false --url=http://ftp.scientificlinux.org/linux/fermi/slf6x/x86_64/os/
hammer repository create --gpg-key="Scientific Linux" --name='SLF 6x security - x86_64' --organization=${MY_ORG} --product='Scientific Linux Fermi 6' --content-type='yum' --publish-via-http=false --url=http://ftp.scientificlinux.org/linux/fermi/slf6x/x86_64/updates/security
hammer repository create --gpg-key="Scientific Linux" --name='SLF 6x fastbugs - x86_64' --organization=${MY_ORG} --product='Scientific Linux Fermi 6' --content-type='yum' --publish-via-http=false --url=http://ftp.scientificlinux.org/linux/fermi/slf6x/x86_64/updates/fastbugs
