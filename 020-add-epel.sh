...
hammer repository create --gpg-key="EPEL" --name='EPEL 7 - x86_64' --organization=${MY_ORG} --product='EPEL' --content-type='yum' --publish-via-http=false --url=http://dl.fedoraproject.org/pub/epel/7/x86_64/
hammer repository create --gpg-key="EPEL" --name='EPEL 6 - x86_64' --organization=${MY_ORG} --product='EPEL' --content-type='yum' --publish-via-http=false --url=http://dl.fedoraproject.org/pub/epel/6/x86_64/
