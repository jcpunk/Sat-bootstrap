...
hammer repository create --gpg-key="ELRepo" --name='ELRepo kmods for EL7 - x86_64' --organization=${MY_ORG} --product='ELRepo' --content-type='yum' --publish-via-http=true --url=http://ftp.osuosl.org/pub/elrepo/elrepo/el7/x86_64/
hammer repository create --gpg-key="ELRepo" --name='ELRepo kernels for EL7 - x86_64' --organization=${MY_ORG} --product='ELRepo' --content-type='yum' --publish-via-http=true --url=http://ftp.osuosl.org/pub/elrepo/kernel/el7/x86_64/
hammer repository create --gpg-key="ELRepo" --name='ELRepo kmods for EL6 - x86_64' --organization=${MY_ORG} --product='ELRepo' --content-type='yum' --publish-via-http=true --url=http://ftp.osuosl.org/pub/elrepo/elrepo/el6/x86_64/
hammer repository create --gpg-key="ELRepo" --name='ELRepo kernels for EL6 - x86_64' --organization=${MY_ORG} --product='ELRepo' --content-type='yum' --publish-via-http=true --url=http://ftp.osuosl.org/pub/elrepo/kernel/el6/x86_64/
